...
# Cria uma classe chamada target com as coordenadas x e y e a imagem do objeto:
class Target:
...
while True:
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN and alvo_1.rectangle.collidepoint(event.pos):
            print('Acertou!')
